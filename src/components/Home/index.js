      ...
      <section className="lerning ">
        <article className="lerning_tiles">
          ...
          <Link to={ROUTES.ACCOUNT}>
            <img className="logo" src={zabawy} alt="Akacjowe zabawy" />
          </Link>
        </article>
        <article className="lerning_tiles">
          <h1 className="tiles_title">Piosenki</h1>
          <Link to={ROUTES.ACCOUNT}>
            <img className="logo" src={piosenki} alt="Akacjowe piosenki" />
          </Link>
        </article>
        <article className="lerning_tiles">
          <h1 className="tiles_title">Zadania</h1>
          <Link to={ROUTES.ACCOUNT}>
            <img className="logo" src={zadania} alt="Akacjowe zadania" />
          </Link>
        </article>
        <article className="lerning_tiles">
          <h1 className="tiles_title">Czytanki</h1>
          <Link to={ROUTES.ACCOUNT}>
            <img className="logo" src={czytanki} alt="Akacjowe czytanki" />
          </Link>
        </article>
      </section>
    </div>
